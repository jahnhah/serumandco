! function(D, u) {
    ...
    function C(D, u, e, F, i, C, n) {
        var E, r, o, l, p, d, a, h, f, c, g, v, w = s(D),
            S = B("paddingLeft", w),
            _ = -999,
            ...
            L = B("fontSize", w) * (u.lineThreshold || .2),
            W = w.textAlign,
            O = [],
            H = [],
            k = [],
        ...
        for (E = 0; E < o; E++)
            if (d = (l = p[E]).parentNode === D, "BR" !== l.nodeName)
                if (G && (f = l.style, P || d || (l._x += l.parentNode._x, l._y += l.parentNode._y), f.left = l._x + "px", f.top = l._y + "px", f.position = "absolute", f.display = "block", f.width = l._w + 1 + "px", f.height = l._h + "px"), !P && q)
                    if (l._isSplit)
                        for (l._next = r = l.nextSibling, l.parentNode.appendChild(l); r && 3 === r.nodeType && " " === r.textContent;) l._next = r.nextSibling, l.parentNode.appendChild(r), r = r.nextSibling;
                    else l.parentNode._isSplit ? (l._parent = l.parentNode, !l.previousSibling && l.firstChild && (l.firstChild._isFirst = !0), l.nextSibling && " " === l.nextSibling.textContent && !l.nextSibling.nextSibling && K.push(l.nextSibling), l._next = l.nextSibling && l.nextSibling._isFirst ? null : l.nextSibling, l.parentNode.removeChild(l), p.splice(E--, 1), o--) : d || (v = !l.nextSibling && z(l.parentNode, D, V), l.parentNode._parent && l.parentNode._parent.appendChild(l), v && l.parentNode.appendChild(X.createTextNode(" ")), "span" === j && (l.style.display = "inline"), O.push(l));
    ...
    function D(D, e, F, i) {
        ...
        for (v.insertBefore(y, D), y.textContent = D.nodeValue, v.removeChild(D), l = -1 !== (C = function getText(D) {
                ...
                return e
            }(D = y)).indexOf("<"), !1 !== e.reduceWhiteSpace && (C = C.replace(b, " ").replace(_, "")), l && (C = C.split("<").join("{{LT}}")), r = C.length, n = (" " === C.charAt(0) ? B : "") + F(), s = 0; s < r; s++)
